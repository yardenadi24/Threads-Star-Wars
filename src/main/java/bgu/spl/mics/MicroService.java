...
public abstract class MicroService implements Runnable { 
    ...
    public MicroService(String name) {
    	this.name= name;
    	this.msb = msb.getInstance();
    	callbacksMap = new HashMap<Class, Callback>();
    }
    ...
    public final void run() {
    	...
    	while(!terminated){
            ...
            try {
                ...
                Callback<Message> newCall = callbacksMap.get(msg.getClass());
                newCall.call(msg);
            } catch (InterruptedException e) {System.out.println(e.fillInStackTrace());}
        }
    	msb.unregister(this);
    }
